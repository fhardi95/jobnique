...
const navLinks = [
  ...
  { href: "/paycheck-calculator",label: "Pay Calculator" },
];
              ...
              {status === "unauthenticated" && (
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  <Link href="/login" onClick={() => setMobileOpen(false)}
                    style={{ textAlign: "center", padding: "11px", fontSize: 14, fontWeight: 500, color: "#374151", border: "1px solid #e5e7eb", borderRadius: 8 }}>
                    Sign in
                  </Link>
                  <Link href="/register" onClick={() => setMobileOpen(false)}
                    style={{ textAlign: "center", padding: "11px", fontSize: 14, fontWeight: 600, color: "#fff", background: "#1a56db", borderRadius: 8 }}>
                    Get started
                  </Link>
                </div>
              )}
