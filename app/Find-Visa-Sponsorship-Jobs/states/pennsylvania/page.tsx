// FILE: app/Find-Visa-Sponsorship-Jobs/states/pennsylvania/page.tsx
...
export const metadata: Metadata = {
  title: "Visa Sponsorship Jobs Available in Pennsylvania 2026 | Jobnique",
  description: "Visa Sponsorship jobs available in Pennsylvania. Browse roles across Pennsylvania from employers offering visa sponsorship in healthcare, IT, engineering, hospitality & skilled trades. PA employers hiring now. Apply today on Jobnique. Updated daily.",
  keywords: `visa sponsorship jobs Pennsylvania, visa sponsorship jobs PA, visa sponsorship jobs PA 2026, visa sponsorship Pennsylvania`,
  alternates: { canonical: `${BASE_URL}/Find-Visa-Sponsorship-Jobs/states/pennsylvania` },
  openGraph: { title: `Visa Sponsorship Jobs in Pennsylvania 2026`, description: "Visa Sponsorship jobs available in Pennsylvania. Browse roles across Pennsylvania from employers offering visa sponsorship in healthcare, IT, engineering, hospitality & skilled trades. PA employers hiring now. Apply today on Jobnique. Updated daily.", url: `${BASE_URL}/Find-Visa-Sponsorship-Jobs/states/pennsylvania`, siteName: "Jobnique", type: "website" },
  robots: { index: true, follow: true },
};

const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: BASE_URL },{ "@type": "ListItem", position: 2, name: "Visa Sponsorship Jobs", item: `${BASE_URL}/Find-Visa-Sponsorship-Jobs` },{ "@type": "ListItem", position: 3, name: "Pennsylvania", item: `${BASE_URL}/Find-Visa-Sponsorship-Jobs/states/pennsylvania` }] };

const faqItems = [
  { q: `What visa sponsorship jobs are available in Pennsylvania?`, a: `Pennsylvania has hundreds of visa-sponsorship roles including retail associates, food service workers, delivery drivers, customer service reps, warehouse staff, healthcare aides, and admin assistants. Philadelphia is the top hiring city in the state.` },
  ...
  { q: `Which city in Pennsylvania has the most visa sponsorship jobs?`, a: `Philadelphia is the largest job market in Pennsylvania and has the highest volume of visa-sponsorship visa-sponsorship roles. The state capital Harrisburg also has strong public sector visa-sponsorship hiring.` },
  { q: `How do I find visa sponsorship jobs in Pennsylvania?`, a: `Browse Jobnique's Pennsylvania listings, filter by visa-sponsorship, and apply to multiple roles daily. Use our free AI Cover Letter Generator and CV guide to strengthen your applications.` },
];
    ...
    <>
      ...
      <div style={{background:"linear-gradient(135deg,#1a56db 0%,#1e40af 100%)",padding:"52px 20px 60px"}}>
        <div style={{maxWidth:860,margin:"0 auto",textAlign:"center"}}>
          ...
          <h1 style={{fontSize:"clamp(26px,4vw,42px)",fontWeight:800,color:"#fff",marginBottom:14,fontFamily:"'DM Serif Display',serif",lineHeight:1.2}}>Visa Sponsorship Jobs in Pennsylvania</h1>
          <p style={{fontSize:17,color:"rgba(255,255,255,0.85)",marginBottom:28,maxWidth:600,margin:"0 auto 28px"}}>Browse visa-sponsorship jobs across Pennsylvania — visa sponsorship opportunities available. Min wage $7.25/hr. Updated daily.</p>
      ...
      <div className="page-grid" style={{maxWidth:1200,margin:"0 auto",padding:"40px 20px 80px",display:"grid",gridTemplateColumns:"1fr 320px",gap:40}}>
        <main>
          <section style={{marginBottom:40}}>
            <h2 style={{fontSize:22,fontWeight:700,color:"#0f172a",marginBottom:16}}>Visa Sponsorship Jobs in Pennsylvania (2026)</h2>
            <p style={{fontSize:15,color:"#374151",lineHeight:1.75,marginBottom:12}}>Pennsylvania has a diverse job market with employers across the state actively hiring visa-sponsorship candidates. From Philadelphia to Harrisburg, there are visa-sponsorship roles in retail, hospitality, healthcare, warehousing, and administration available right now.</p>
          ...
          <section style={{marginBottom:48}}>
            <h2 style={{fontSize:20,fontWeight:700,color:"#0f172a",marginBottom:16}}>Latest Visa Sponsorship Jobs — Pennsylvania <span style={{fontSize:13,fontWeight:400,color:"#6b7280"}}>Updated today</span></h2>
            {jobs.length === 0 ? (
            ...
            <div style={{marginTop:20,textAlign:"center"}}><Link href={`/jobs?location=PA&source=all`} style={{display:"inline-block",border:"2px solid #1a56db",color:"#1a56db",borderRadius:10,padding:"12px 32px",fontWeight:700,fontSize:14,textDecoration:"none"}}>View All Visa Sponsorship Jobs in Pennsylvania →</Link></div>
          </section>
        ...
        <aside style={{display:"flex",flexDirection:"column",gap:20}}>
          ...
          <form action="/api/newsletter" method="POST" style={{background:"linear-gradient(135deg,#1a56db,#1e40af)",borderRadius:12,padding:20,color:"#fff"}}>
            ...
            <p style={{fontSize:13,color:"rgba(255,255,255,0.8)",marginBottom:16}}>Be first to know when new visa-sponsorship jobs are posted in Pennsylvania.</p>
