// FILE: app/entry-level-jobs/indianapolis/page.tsx
// Auto-generated — jobnique.com/entry-level-jobs/indianapolis
...
const CITY_LABEL = "Indianapolis, IN";
const CITY_SLUG = "indianapolis";
const CITY_SEARCH = "Indianapolis";
const MIN_WAGE = "$7.25";
const STATE_CODE = "IN";

export const metadata: Metadata = {
  title: "Entry Level Jobs Available in Indianapolis, IN 2026 | Jobnique",
  description: "Entry Level jobs available in Indianapolis, IN. Browse entry-level roles in retail, hospitality, healthcare, warehouse, admin & customer service. No prior experience needed — apply today and start your career in Indianapolis. Updated daily on Jobnique.",
  keywords: `entry level jobs Indianapolis, entry level jobs Indianapolis IN, jobs entry level Indianapolis, entry level Indianapolis 2026`,
  alternates: { canonical: `${BASE_URL}/entry-level-jobs/indianapolis` },
  openGraph: {
    title: `Entry Level Jobs in Indianapolis 2026 – Entry Level Hiring Now`,
    description: `Browse entry level jobs in Indianapolis, IN. Entry-level roles in retail, hospitality, healthcare & more. Updated daily.`,
    url: `${BASE_URL}/entry-level-jobs/indianapolis`,
    siteName: "Jobnique",
    type: "website",
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Indianapolis", item: `${BASE_URL}/entry-level-jobs/indianapolis` },
  ],
};

const faqItems = [
  { q: `What jobs can I get in Indianapolis for entry level candidates?`, a: `Indianapolis has hundreds of entry-level roles requiring no prior experience, including retail associates, food service workers, delivery drivers, customer service representatives, warehouse staff, caregivers, and administrative assistants. Many employers provide paid on-the-job training.` },
  { q: `What is the minimum wage in Indianapolis in 2026?`, a: `As of 2026, the minimum wage in Indianapolis, IN is $7.25 per hour. Always check your state Department of Labor for the latest rates.` },
  { q: `How do I get a job in Indianapolis for entry level candidates?`, a: `Target industries that hire beginners: retail, hospitality, food service, and warehouse work. Write a strong CV highlighting soft skills, then use our free AI Cover Letter tool to create tailored applications. Apply to multiple listings daily.` },
  { q: `How much do entry-level jobs pay in Indianapolis?`, a: `Entry-level entry-level jobs in Indianapolis typically pay between $7.25 and $25 per hour depending on the industry. The IN minimum wage in 2026 is $7.25/hr.` },
  { q: `Do I need a resume to apply for entry level jobs in Indianapolis?`, a: `Most employers ask for a CV even for entry-level roles. Focus on your soft skills, education, and activities. Use our free CV guide or Resume Builder to create a strong application.` },
];
    ...
    <>
      ...
      <div style={{background:"#f9fafb",borderBottom:"1px solid #e5e7eb",padding:"10px 20px"}}>
        <nav aria-label="breadcrumb" style={{maxWidth:1200,margin:"0 auto",fontSize:13,color:"#6b7280"}}>
          ...
          <span style={{margin:"0 8px"}}>›</span>
          <span style={{color:"#111827",fontWeight:500}}>Indianapolis</span>
        </nav>
      </div>
      ...
      <div style={{background:"linear-gradient(135deg,#1a56db 0%,#1e40af 100%)",padding:"52px 20px 60px"}}>
        <div style={{maxWidth:860,margin:"0 auto",textAlign:"center"}}>
          ...
          <h1 style={{fontSize:"clamp(26px,4vw,42px)",fontWeight:800,color:"#fff",marginBottom:14,fontFamily:"'DM Serif Display',serif",lineHeight:1.2}}>
            Entry Level Jobs in Indianapolis
          </h1>
          <p style={{fontSize:17,color:"rgba(255,255,255,0.85)",marginBottom:28,maxWidth:600,margin:"0 auto 28px"}}>
            Browse entry-level jobs across Indianapolis, IN — entry level positions available. Retail, hospitality, healthcare, admin & more. Updated daily.
          </p>
      ...
      <div className="page-grid" style={{maxWidth:1200,margin:"0 auto",padding:"40px 20px 80px",display:"grid",gridTemplateColumns:"1fr 320px",gap:40}}>
        <main>
          <section style={{marginBottom:40}}>
            <h2 style={{fontSize:22,fontWeight:700,color:"#0f172a",marginBottom:16}}>Finding Entry Level Jobs in Indianapolis (2026)</h2>
            <p style={{fontSize:15,color:"#374151",lineHeight:1.75,marginBottom:12}}>
              Indianapolis is an active job market with hundreds of employers hiring entry-level candidates every week — no prior experience needed. From retail floors to hospital wards, warehouses to call centres, there are roles across every sector that welcome beginners and provide on-the-job training from day one.
            </p>
            <p style={{fontSize:15,color:"#374151",lineHeight:1.75,marginBottom:12}}>
              Whether you&apos;re a student, recent graduate, career changer, or returning to work — Indianapolis has entry-level opportunities that fit your schedule. The IN minimum wage in 2026 is <strong>$7.25/hr</strong>, ensuring a solid earnings floor even for your first role.
            </p>
            <p style={{fontSize:15,color:"#374151",lineHeight:1.75}}>
              The most active hiring sectors in Indianapolis for entry-level roles are retail and sales, food service, warehouse and logistics, healthcare aides, customer service, and administrative support. Many positions offer immediate starts.
            </p>
          </section>
          ...
          <section style={{marginBottom:48}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
              <h2 style={{fontSize:20,fontWeight:700,color:"#0f172a"}}>
                Latest Entry Level Jobs — Indianapolis
            ...
            <div style={{marginTop:20,textAlign:"center"}}>
              <Link href={`/jobs?location=${encodeURIComponent(CITY_SEARCH)}&source=all`} style={{display:"inline-block",border:"2px solid #1a56db",color:"#1a56db",borderRadius:10,padding:"12px 32px",fontWeight:700,fontSize:14,textDecoration:"none"}}>
                View All Entry Level Jobs in Indianapolis →
              </Link>
            </div>
          </section>

          <section style={{marginBottom:48}}>
            <h2 style={{fontSize:22,fontWeight:700,color:"#0f172a",marginBottom:16}}>Top Industries Hiring For Entry Level Candidates in Indianapolis</h2>
          ...
          <section style={{marginBottom:48}}>
            <h2 style={{fontSize:22,fontWeight:700,color:"#0f172a",marginBottom:16}}>What Do Entry Level Jobs Pay in Indianapolis?</h2>
            ...
            <p style={{fontSize:12,color:"#9ca3af",marginTop:10}}>
              Estimates based on 2026 Indianapolis market data.{" "}
        ...
        <aside style={{display:"flex",flexDirection:"column",gap:20}}>
          ...
          <div style={{background:"#fff",border:"1px solid #e5e7eb",borderRadius:12,padding:20}}>
            <h3 style={{fontWeight:700,fontSize:15,color:"#0f172a",marginBottom:8}}>Indianapolis Min. Wage 2026</h3>
            <div style={{fontSize:36,fontWeight:800,color:"#1a56db"}}>$7.25<span style={{fontSize:16,fontWeight:400,color:"#6b7280"}}>/hr</span></div>
            <p style={{fontSize:12,color:"#9ca3af",marginTop:4,marginBottom:14}}>IN minimum wage, effective 2026</p>
          ...
          <form action="/api/newsletter" method="POST" style={{background:"linear-gradient(135deg,#1a56db,#1e40af)",borderRadius:12,padding:20,color:"#fff"}}>
            ...
            <p style={{fontSize:13,color:"rgba(255,255,255,0.8)",marginBottom:16}}>Be first to know when new entry-level jobs are posted in Indianapolis.</p>
