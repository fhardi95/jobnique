// FILE: app/jobs-near-me/states/louisiana/page.tsx
...
export const metadata: Metadata = {
  title: "Jobs Near Me in Louisiana 2026 | Jobnique",
  description: "Jobs near me in Louisiana. Browse local job openings across Louisiana hiring now in retail, hospitality, healthcare, warehouse, admin & customer service. LA employers hiring now. Apply today on Jobnique. Updated daily.",
  keywords: `jobs near me Louisiana, jobs near me LA, jobs near me LA 2026, local Louisiana`,
  alternates: { canonical: `${BASE_URL}/jobs-near-me/states/louisiana` },
  openGraph: { title: `Jobs Near Me in Louisiana 2026`, description: "Jobs near me in Louisiana. Browse local job openings across Louisiana hiring now in retail, hospitality, healthcare, warehouse, admin & customer service. LA employers hiring now. Apply today on Jobnique. Updated daily.", url: `${BASE_URL}/jobs-near-me/states/louisiana`, siteName: "Jobnique", type: "website" },
  robots: { index: true, follow: true },
};

const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: BASE_URL },{ "@type": "ListItem", position: 2, name: "Jobs Near Me", item: `${BASE_URL}/jobs-near-me` },{ "@type": "ListItem", position: 3, name: "Louisiana", item: `${BASE_URL}/jobs-near-me/states/louisiana` }] };

const faqItems = [
  { q: `What jobs near me are available in Louisiana?`, a: `Louisiana has hundreds of jobs-near-me roles including retail associates, food service workers, delivery drivers, customer service reps, warehouse staff, healthcare aides, and admin assistants. New Orleans is the top hiring city in the state.` },
  ...
  { q: `Which city in Louisiana has the most jobs near me?`, a: `New Orleans is the largest job market in Louisiana and has the highest volume of jobs-near-me jobs-near-me roles. The state capital Baton Rouge also has strong public sector jobs-near-me hiring.` },
  { q: `How do I find jobs near me in Louisiana?`, a: `Browse Jobnique's Louisiana listings, filter by jobs-near-me, and apply to multiple roles daily. Use our free AI Cover Letter Generator and CV guide to strengthen your applications.` },
];
    ...
    <>
      ...
      <div style={{background:"linear-gradient(135deg,#1a56db 0%,#1e40af 100%)",padding:"52px 20px 60px"}}>
        <div style={{maxWidth:860,margin:"0 auto",textAlign:"center"}}>
          ...
          <h1 style={{fontSize:"clamp(26px,4vw,42px)",fontWeight:800,color:"#fff",marginBottom:14,fontFamily:"'DM Serif Display',serif",lineHeight:1.2}}>Jobs Near Me in Louisiana</h1>
          <p style={{fontSize:17,color:"rgba(255,255,255,0.85)",marginBottom:28,maxWidth:600,margin:"0 auto 28px"}}>Browse jobs-near-me jobs across Louisiana — local job openings available. Min wage $7.25/hr. Updated daily.</p>
      ...
      <div className="page-grid" style={{maxWidth:1200,margin:"0 auto",padding:"40px 20px 80px",display:"grid",gridTemplateColumns:"1fr 320px",gap:40}}>
        <main>
          <section style={{marginBottom:40}}>
            <h2 style={{fontSize:22,fontWeight:700,color:"#0f172a",marginBottom:16}}>Jobs Near Me in Louisiana (2026)</h2>
            <p style={{fontSize:15,color:"#374151",lineHeight:1.75,marginBottom:12}}>Louisiana has a diverse job market with employers across the state actively hiring jobs-near-me candidates. From New Orleans to Baton Rouge, there are jobs-near-me roles in retail, hospitality, healthcare, warehousing, and administration available right now.</p>
          ...
          <section style={{marginBottom:48}}>
            <h2 style={{fontSize:20,fontWeight:700,color:"#0f172a",marginBottom:16}}>Latest Jobs Near Me — Louisiana <span style={{fontSize:13,fontWeight:400,color:"#6b7280"}}>Updated today</span></h2>
            {jobs.length === 0 ? (
            ...
            <div style={{marginTop:20,textAlign:"center"}}><Link href={`/jobs?location=LA&source=all`} style={{display:"inline-block",border:"2px solid #1a56db",color:"#1a56db",borderRadius:10,padding:"12px 32px",fontWeight:700,fontSize:14,textDecoration:"none"}}>View All Jobs Near Me in Louisiana →</Link></div>
          </section>
        ...
        <aside style={{display:"flex",flexDirection:"column",gap:20}}>
          ...
          <form action="/api/newsletter" method="POST" style={{background:"linear-gradient(135deg,#1a56db,#1e40af)",borderRadius:12,padding:20,color:"#fff"}}>
            ...
            <p style={{fontSize:13,color:"rgba(255,255,255,0.8)",marginBottom:16}}>Be first to know when new jobs-near-me jobs are posted in Louisiana.</p>
