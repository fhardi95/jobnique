// FILE: app/jobs-near-me/new-york/page.tsx
// Deploy at: jobnique.com/jobs-near-me/new-york
...
export const metadata: Metadata = {
  ...
  description: "Jobs near me in New York, NY. Browse local job openings hiring now in retail, hospitality, healthcare, warehouse, admin & customer service near New York. Apply today on Jobnique. Updated daily.",
  keywords:
    "jobs near me New York, jobs near me NYC, jobs local New York, local New York 2026",
  alternates: { canonical: `${BASE_URL}/jobs-near-me/new-york` },
  openGraph: {
    title: "Jobs Near Me in New York 2026 – Hiring Now",
    description:
      "Browse 1,000+ jobs near me in New York City. Entry-level roles in retail, hospitality, healthcare, admin & more. Updated daily.",
    url: `${BASE_URL}/jobs-near-me/new-york`,
    siteName: "Jobnique",
    type: "website",
  },
  twitter: {
    card: "summary",
    title: "Jobs Near Me in New York 2026",
    description: "Browse 1,000+ jobs-near-me jobs in NYC – local.",
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "New York", item: `${BASE_URL}/jobs-near-me/new-york` },
  ],
};

const faqItems = [
  {
    q: "What jobs can I get in New York for local candidates?",
    a: "New York City has thousands of jobs-near-me roles requiring no prior experience, including retail associates, food service workers, delivery drivers, customer service representatives, warehouse staff, caregivers, and administrative assistants. Many employers provide paid on-the-job training.",
  },
  {
  ...
  {
    q: "How do I get a job in New York City for local candidates?",
  ...
  {
    q: "How much do jobs-near-me jobs pay in New York City?",
    a: "Entry-level jobs-near-me jobs in New York City typically pay between $16.50 and $25 per hour depending on the industry. The NYC minimum wage in 2026 is $16.50/hr.",
  },
  {
    q: "Do I need a resume to apply for jobs near me in NYC?",
    a: "Most employers ask for a CV even for jobs-near-me roles. Focus on your soft skills, education, and any activities. Use our free CV guide or Resume Builder to create a strong application for local candidates.",
  },
];
      ...
      <div style={{ background: "linear-gradient(135deg, #1a56db 0%, #1e40af 100%)", padding: "52px 20px 60px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 800, color: "#fff", marginBottom: 14, fontFamily: "'DM Serif Display', serif", lineHeight: 1.2 }}>
            Jobs Near Me in New York
          </h1>
          <p style={{ fontSize: 17, color: "rgba(255,255,255,0.85)", marginBottom: 28, maxWidth: 600, margin: "0 auto 28px" }}>
            Browse 1,000+ jobs-near-me jobs across New York City — local job openings available. Retail, hospitality, healthcare, admin & more. Updated daily.
          </p>
        ...
        <main>
          ...
          <section style={{ marginBottom: 40 }}>
            <h2 style={{ fontSize: 22, fontWeight: 700, color: "#0f172a", marginBottom: 16 }}>
              Finding Jobs Near Me in New York City (2026)
            </h2>
            <p style={{ fontSize: 15, color: "#374151", lineHeight: 1.75, marginBottom: 12 }}>
              New York City is one of the most dynamic job markets in the world — and you can start your career here to land your first role here. Thousands of employers across Manhattan, Brooklyn, the Bronx, Queens, and Staten Island actively hire jobs-near-me candidates every day, offering paid training, flexible hours, and a clear path to career growth.
            </p>
            <p style={{ fontSize: 15, color: "#374151", lineHeight: 1.75, marginBottom: 12 }}>
              Whether you&apos;re a recent high school graduate, a college student, a career changer, or returning to the workforce — New York has jobs-near-me jobs in virtually every industry. The city&apos;s minimum wage in 2026 is <strong>$16.50/hr</strong>, giving jobs-near-me workers a solid earning floor from day one.
            </p>
            <p style={{ fontSize: 15, color: "#374151", lineHeight: 1.75 }}>
              The most active hiring sectors for jobs-near-me roles in NYC are retail and sales, food service and hospitality, warehouse and logistics, healthcare aides, customer service, and administrative support. Many of these roles offer immediate starts with on-the-job training.
            </p>
          </section>
          ...
          <section style={{ marginBottom: 48 }}>
            <h2 style={{ fontSize: 22, fontWeight: 700, color: "#0f172a", marginBottom: 16 }}>
              Top Industries Hiring Near You in NYC
            </h2>
          ...
          <section style={{ marginBottom: 48 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                ...
                { step: "04", title: "Prepare for your interview", body: "Most jobs-near-me interviews focus on personality, reliability, and attitude rather than skills. Practice answers to questions like 'Why do you want to work here?' and 'Tell me about yourself.'", link: { label: "Practice with Interview Question Generator →", href: "/interview-question-generator" } },
              ].map((item) => (
          ...
          <section style={{ marginBottom: 48 }}>
            <h2 style={{ fontSize: 22, fontWeight: 700, color: "#0f172a", marginBottom: 16 }}>
              What Do Jobs Near Me Pay in New York?
            </h2>
          ...
          {nearbyCities.length > 0 && (
            <section style={{ marginBottom: 40 }}>
              <h2 style={{ fontSize: 18, fontWeight: 700, color: "#0f172a", marginBottom: 14 }}>
                Jobs Near Me in Nearby Cities
              </h2>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {nearbyCities.map((c) => (
                  <Link key={c.slug} href={`/jobs-near-me/${c.slug}`} className="city-pill">
                    {c.label}
                  </Link>
                ))}
              </div>
          ...
          <section>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 14 }}>
              {[
                { title: "How to Write a CV Near You (2026)", href: "/career-advice/how-to-write-cv-with-no-experience-2026-guide", tag: "CV Writing" },
        ...
        <aside style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {[
                ...
                { label: "📄 CV Guide – Resume Tips", href: "/career-advice/how-to-write-cv-with-no-experience-2026-guide" },
          ...
          <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
              {sidebarCities.map((c) => (
                <Link key={c.slug} href={`/jobs-near-me/${c.slug}`} className="sidebar-city-link">
                  <span>📍 {c.name}</span>
          ...
          <form action="/api/newsletter" method="POST" style={{ background: "linear-gradient(135deg, #1a56db, #1e40af)", borderRadius: 12, padding: 20, color: "#fff" }}>
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.8)", marginBottom: 16 }}>
              Be first to know when new jobs-near-me jobs are posted in NYC.
            </p>
            <input
              type="email"
              name="email"
